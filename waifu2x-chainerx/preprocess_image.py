...
DATA_PREFIX = "/nfs/ug/thesis/thesis0/mkccgrp/cartoon_train_jpeg/"
PREPROCESSED_PREFIX = "/nfs/ug/thesis/thesis0/mkccgrp/cartoons_scaled/"
QUALITY = 96
...
if __name__ == '__main__':
    ...
    for i, (filename, image) in enumerate(get_images()):
        cover = resizeimage.resize_contain(image, [QUALITY, QUALITY]).convert("RGB")
        cover.save(PREPROCESSED_PREFIX + filename + '.jpg', image.format)
