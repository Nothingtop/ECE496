...
if args.output_folder is None:
    # Display in windows
    print("Displaying output image on screen (no --output_folder specified)")
    ...
    print("Saving output image: {}".format(args.output_folder + args.filename))
    cv2.imwrite(args.output_folder + args.filename, cv2.cvtColor(outputImage, cv2.COLOR_RGB2BGR))
